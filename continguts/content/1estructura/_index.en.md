...
En aquesta primera part del temari introduirem que és un programa informàtic, en què consisteix la  programació estructurada i concretament com ho treballarem a partir de `Java`, el llenguatge de programació que utilitzarem durant tot el mòdul. Els diferents apartats en els que es divideixen són:
...
6. [Estructura sequencial]({{%relref "1estructura/6sequencial/_index.en.md" %}})
7. [Estructures de selecció]({{%relref "1estructura/7condicional/_index.en.md" %}})
8. [Estructures de repetició i de salt]({{%relref "1estructura/8iteratiu/_index.en.md" %}})
9. [Excepcions]({{%relref "1estructura/9excepcions/_index.en.md" %}})
10. [Depuració de codi i assercions]({{%relref "1estructura/10depuracioAssercions/_index.en.md" %}})
