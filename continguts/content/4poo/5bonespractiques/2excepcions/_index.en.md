...
_Exemples més complerts amb encadenament d'excepcions_
...
Aquesta excepció s'instancia un cop es genera l'Excepció (_throw new MajoriaEdatExcepcio(n)_). Per tant, la situació podria ser la següent:
